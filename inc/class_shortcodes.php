...
class Shortcodes {
	...
	public function wall_shortcodes( $atts ) {
		...
		ob_start();
		?>
		<!--  Generated by Simple Wall <?php echo esc_attr( SIMPLE_VERSION ); ?> https://wordpress.org/plugins/simple-wall/ -->
...
$simpleWall_shortcodes = new Shortcodes();
$simpleWall_shortcodes->init();
