...
class Shortcodes {
	...
	public function wall_shortcodes( $atts ) {
		...
		ob_start();
		?>
		<!--  Generated by Simple Wall <?php echo SIMPLE_VERSION; ?> https://wordpress.org/plugins/simple-wall/ -->
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/' . $locale . '/sdk.js#xfbml=1&version=v13.0" nonce="V2oYdNpC"></script>';
			}
		}
	}
}
